...
export function NewHabitForm() {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
                ...
                {availableWeekDays.map((weekDay, index) => {
                    return (
                        ...
                        >
                            ...
                            group-focus:ring-violet-900 group-focus:ring-offset-2 group-focus:ring-offset-background'
                            >
            ...
            <button
                type="submit"
                className="mt-6 rounded-lg p-4 flex items-center -center gap-3 font-semibold
